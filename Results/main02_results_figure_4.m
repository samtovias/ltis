...
txt1 = {'LTIS', 'EIS', 'CNN', 'ENN', 'ICF', 'DROP3'};
txt2 = {'ACC' 'RR' 'HDC' 'E'};
...
ylabel('performance measure value','FontSize',14,'interpreter','latex');
ylim([0 1.3]);
...
for i = 1:size(ctr,2)
   for j = 1:size(ctr,1) 
       text(ctr(j,i)+0.05,1.145,sprintf('$%0.3f$',M1(j,i)),'HorizontalAlignment','center','Rotation',60,'Interpreter','latex','FontSize',14);
   end
end
